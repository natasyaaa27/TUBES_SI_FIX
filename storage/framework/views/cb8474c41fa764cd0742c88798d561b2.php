                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" action="<?php echo e(route('stok_produksi.update', $stok_produksi->id_stokPr)); ?>"
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <select class="form-control" name="id_produksi" id="id_produksi" required>
                                                ...
                                                <?php $__currentLoopData = $produksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        <?php echo e($k->id_produksi == $stok_produksi->id_produksi ? 'selected' : ''); ?>

                                                        value="<?php echo e($k->id_produksi); ?>">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="middle-name" name="stok_produksi"
                                                value="<?php echo e($stok_produksi->stok_produksi); ?>" class="form-control" type="number"
                                                name="middle-name">
                                        </div>
                                    </div>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tubes_SI\resources\views/stok-produksi/edit-stok-produksi.blade.php ENDPATH**/ ?>